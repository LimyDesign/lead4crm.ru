 ...
 * @copyright       Arsen Bespalov <bespalov@arsen.pw>
...
class Lead4CRM
{
     ...
     * @var array
     */
    static protected $pgsql_credentials = array();
    ...
    public static function initialize(array $credentials, $table_prefix = null)
    {
        if (empty($credentials)) {
            throw new TelegramException('PostgreSQL credentials not provided!');
        }
        self::$pgsql_credentials = $credentials;
