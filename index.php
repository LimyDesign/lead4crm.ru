...
// 						 . '"'.$template['website']['title'].'";'
// 						 . '"'.$template['facebook']['title'].'";'
// 						 . '"'.$template['twitter']['title'].'";'
// 						 . '"'.$template['other_site']['title'].'";'
...
// 						$csv .= '"'.implode(',', $fax).'";';
// 						$csv .= '"'.implode(',', $email).'";';
// 						$csv .= '"'.str_replace('"', '""', getMainIndustry($cp['rubrics'])).'";';
...
// 						$csv .= '"'.implode(',', $website).'";';
// 						$csv .= '"'.implode(',', $facebook).'";';
// 						$csv .= '"'.implode(',', $twitter).'";';
// 						$csv .= '"'.implode(',', $other_site).'";';
// 						$csv .= '"'.implode(',', $skype).'";';
// 						$csv .= '"'.implode(',', $icq).'";';
// 						$csv .= '"'.str_replace('"', '""', $comment).'";';
// 						$csv .= "\n";
// 					}
// 				}
// 				if ($type == 'csv') {
